...
// SVG icon components for better readability and state indication
const EyeIcon = () => (
            ...
            <div className="w-full max-w-md mx-auto p-4">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <form onSubmit={(e) => e.preventDefault()}>
                        ...
                        {/* Login Button */}
                        <button type="submit" className="w-full bg-teal-700 text-white font-bold py-3 px-4 rounded-lg hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-700 transition duration-300">
                            Login
                        </button>
                    </form>
                </div>
                ...
                <div className="text-center mt-6">
                    <p className="text-xs text-gray-500">Access restricted to authorized administrators.</p>
                </div>
            </div>
        </div>
    );
